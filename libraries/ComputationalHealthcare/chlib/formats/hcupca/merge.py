...
import formats
FILES = [
    {'state':'CA','file_type':'CORE','dataset_type':'SEDD','year':2006,'filename':'CA_SEDD_2006_CORE.asc.gz','link':'CA_2006_daystoevent.csv.gz'},
    {'state':'CA','file_type':'CORE','dataset_type':'SEDD','year':2007,'filename':'CA_SEDD_2007_CORE.asc.gz','link':'CA_2007_daystoevent.csv.gz'},
    {'state':'CA','file_type':'CORE','dataset_type':'SEDD','year':2008,'filename':'CA_SEDD_2008_CORE.asc.gz','link':'CA_2008_daystoevent.csv.gz'},
    {'state':'CA','file_type':'CORE','dataset_type':'SEDD','year':2009,'filename':'CA_SEDD_2009_CORE.asc.gz'},
    {'state':'CA','file_type':'CORE','dataset_type':'SEDD','year':2010,'filename':'CA_SEDD_2010_CORE.asc.gz'},
    {'state':'CA','file_type':'CORE','dataset_type':'SEDD','year':2011,'filename':'CA_SEDD_2011_CORE.asc.gz'},
    ...
    {'state':'CA','file_type':'CORE','dataset_type':'SASD','year':2006,'filename':'CA_SASD_2006_CORE.asc.gz','link':'CA_2006_daystoevent.csv.gz'},
    {'state':'CA','file_type':'CORE','dataset_type':'SASD','year':2007,'filename':'CA_SASD_2007_CORE.asc.gz','link':'CA_2007_daystoevent.csv.gz'},
    {'state':'CA','file_type':'CORE','dataset_type':'SASD','year':2008,'filename':'CA_SASD_2008_CORE.asc.gz','link':'CA_2008_daystoevent.csv.gz'},
    {'state':'CA','file_type':'CORE','dataset_type':'SASD','year':2009,'filename':'CA_SASD_2009_CORE.asc.gz'},
    {'state':'CA','file_type':'CORE','dataset_type':'SASD','year':2010,'filename':'CA_SASD_2010_CORE.asc.gz'},
    {'state':'CA','file_type':'CORE','dataset_type':'SASD','year':2011,'filename':'CA_SASD_2011_CORE.asc.gz'},
]
